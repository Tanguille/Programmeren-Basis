...
==== Oplossing D07.karakterperpositie
// Y.01
[source,csharp,linenums]
----
Console.Write("Geef een tekst : ");
...
==== Oplossing D07.beginmethoofdletters
...
==== Oplossing D07.klinkersenmedeklinkers
// Y1.08
